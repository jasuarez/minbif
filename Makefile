...
CMAKE_OPTIONS = -DCMAKE_BUILD_TYPE=Debug -DCMAKE_VERBOSE_MAKEFILE=0 \
                -DENABLE_CACA=$(ENABLE_CACA) -DENABLE_VIDEO=$(ENABLE_VIDEO) -DENABLE_PLUGIN=$(ENABLE_PLUGIN) \
                -DENABLE_PAM=$(ENABLE_PAM) -DENABLE_MINBIF=$(ENABLE_MINBIF) -DENABLE_TLS=$(ENABLE_TLS) \
